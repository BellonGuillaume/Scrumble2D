...
public class StateManager : MonoBehaviour
{
    ...
    public enum GameState{
        MENU, POKER_PLANNING, CUSTOM_POKER_PLANNING, INITIALISATION, BEGIN_GAME, TDTD, BEGIN_DAY, PICK_DAILY, PLAYER_TURN, END_OF_DAY, REVIEW, REVIEW_CARDS, SUMMARY, RETROSPECTIVE, END_OF_SPRINT,
    }
